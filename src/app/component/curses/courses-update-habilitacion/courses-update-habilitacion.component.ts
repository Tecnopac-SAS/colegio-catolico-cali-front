...
@Component({
  selector: 'app-courses-update-habilitacion',
  templateUrl: './courses-update-habilitacion.component.html',
  styleUrls: ['./courses-update-habilitacion.component.css']
})
export class CoursesUpdateHabilitacionComponent implements OnInit {
