...
@Component({
  selector: 'app-pazysalvocuatrosellos',
  templateUrl: './pazysalvocuatrosellos.component.html',
  styleUrls: ['./pazysalvocuatrosellos.component.css']
})
export class PazysalvocuatrosellosComponent implements OnInit {

  grade !: any;
  navTitle="Paz y salvo 4 sellos"
  formValue !:FormGroup
