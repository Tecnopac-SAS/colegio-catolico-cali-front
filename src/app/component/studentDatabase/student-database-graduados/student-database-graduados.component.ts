...
@Component({
  selector: 'app-student-database-graduados',
  templateUrl: './student-database-graduados.component.html',
  styleUrls: ['./student-database-graduados.component.css']
})
export class StudentDatabaseGraduadosComponent implements OnInit {
  ...
  navTitle="Estudiantes Graduados"
  formValue !:FormGroup
